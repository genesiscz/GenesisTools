...
- **What it is:** `cloudflared` on the Mac dials out to CF edge; phone hits `https://mac.example.dev`; CF routes to the tunnel. Already wired (see above).
