...
🛑 **CI runs bun 1.4.2 (which has the hang fix); the repo still SUPPORTS 1.3.13, which is what developers run.** A 1.4-only API must not enter the codebase just because CI is green.
