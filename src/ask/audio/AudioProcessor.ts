...
export class AudioProcessor {
  ...
  async getAudioInfo(filePath: string): Promise<{
    ...
    try {
      ...
      const probeData = JSON.parse(stdout) as { streams?: FFprobeStream[]; format?: { duration?: string; size?: string; bit_rate?: string } };
      ...
      return {
        ...
        duration: parseFloat(audioStream.duration || probeData.format?.duration || "0"),
