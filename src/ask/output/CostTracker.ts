...
import type { CostBreakdown, LanguageModelUsage } from "../types";
...
export class CostTracker {
  ...
  async trackUsage(
    ...
    logger.debug(`Tracked usage: ${provider}/${model} - ${dynamicPricingManager.formatTokens(usage.totalTokens || 0)} tokens, ${dynamicPricingManager.formatCost(cost)}`);
  }
