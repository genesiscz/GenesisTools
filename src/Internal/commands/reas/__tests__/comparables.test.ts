...
describe("analyzeComparables()", () => {
    ...
    const listings: ReasListing[] = [
        makeListing(3_000_000, 60, 3_200_000, "2024-06-01", "2024-03-01"),
        makeListing(4_000_000, 80, 4_000_000, "2024-07-01", "2024-05-01"),
        makeListing(2_500_000, 50, 2_800_000, "2024-08-01", "2024-06-15"),
    ];
