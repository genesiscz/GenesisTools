...
const RULES: Rule[] = [
    ...
    { pattern: /^Brave Browser/, label: "Brave browser" },
    { pattern: /^Google Chrome/, label: "Chrome browser" },
    { pattern: /^Safari$/, label: "Safari" },
    { pattern: /^firefox$|^Firefox$/, label: "Firefox" },
    { pattern: /^Arc( Helper)?$/, label: "Arc browser" },
    { pattern: /^Orion( Helper)?$/, label: "Orion browser" },
