    ...
    return (
        <header className="sticky top-0 z-20 flex min-h-16 items-center justify-between border-b border-primary/20 bg-background/78 px-4 backdrop-blur-xl lg:px-6">
            <div className="flex items-center gap-3">
                <Link to="/" className="grid size-10 place-items-center rounded-xl border border-primary/30 bg-primary/10 text-primary lg:hidden">
                    <Menu className="size-5" />
                </Link>
                <div>
                    <p className="font-mono text-[0.65rem] uppercase tracking-[0.32em] text-secondary">YouTube Pipeline</p>
            ...
            <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2 rounded-full border border-primary/20 bg-black/25 px-3 py-1.5 text-xs font-mono">
                    <span className={connected ? "size-2 rounded-full bg-emerald-400 shadow-[0_0_12px_rgba(52,211,153,0.8)]" : "size-2 rounded-full bg-muted-foreground"} />
