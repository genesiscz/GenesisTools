    ...
    return {
        ...
        Channel: {
            ...
            properties: {
                ...
                subscriberCount: nullableNumber(),
        ...
        Video: {
            ...
            properties: {
                ...
                audioSizeBytes: nullableNumber(),
                audioCachedAt: nullableString(),
                videoPath: nullableString(),
                videoSizeBytes: nullableNumber(),
            ...
            properties: {
                ...
                concurrency: {
                    ...
                    properties: {
                        ...
                        localTranscribe: { type: "number" },
                        cloudTranscribe: { type: "number" },
                        summarize: { type: "number" },
                    },
                    additionalProperties: true,
                },
                ttls: {
            ...
            post: {
                ...
                requestBody: jsonBody({
                    ...
                    properties: {
                        ...
                        targetBins: { type: "number", description: "Override section count for 'timestamped'." },
                    },
                }),
                responses: {
                ...
                requestBody: jsonBody(
                    {
                        ...
                        properties: {
                            ...
                            topK: { type: "number", description: "Number of transcript chunks to retrieve." },
                            provider: { type: "string" },
                            model: { type: "string" },
                        },
                        required: ["question"],
