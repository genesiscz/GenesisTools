...
import { indexEntries, filterByLevel } from "@app/debugging-master/core/log-parser";
import { formatEntryLine } from "@app/debugging-master/core/formatter";
import type { LogEntry, IndexedLogEntry } from "@app/debugging-master/types";
				...
				try {
					...
					for (const line of lines) {
						...
						try {
							...
							const fallback: IndexedLogEntry = { level: "raw", msg: line, ts: Date.now(), index: entryIndex };
