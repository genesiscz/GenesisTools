 ...
 * accept "/tmp/sbX-evil" for root "/tmp/sbX". Only a whole `..` segment leaves the root; a
 * child named `..cache` is inside it, and treating it as outside let a write into the real
 * store through the guard.
 */
