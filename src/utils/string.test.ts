...
describe("probeCooccurrence", () => {
    it("matches when all secondaries appear in ONE primary window", () => {
    ...
    it("does not match when the secondary is outside the window", () => {
    ...
    it("requires ALL secondaries in the SAME window", () => {
