 ...
 */
export function formatDuration(value: number, unit: DurationUnit = "ms", style: DurationStyle = "tiered"): string {
 ...
 * For a full-featured stopwatch with laps/stamps, use Stopwatch from @genesiscz/utils/Stopwatch.
 *
 * @example
