...
export interface SummaryTabProps {
    ...
    useSummary: (id: VideoId | null, mode: "short" | "timestamped") => { data: { timestamped?: TimestampedSummaryEntry[] } | undefined; isPending: boolean };
}

export function SummaryTab({ videoId, onSeek, useSummary }: SummaryTabProps) {
