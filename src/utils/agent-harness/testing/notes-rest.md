...
6. **`localfile.Store` becomes `LocalStore` (rest-helpers).** An in-memory twin of the localfile
   ...
   <!-- updated 2026-09-24 06:14: MemoryStore.resume now keeps the same Resume contract (PR #422 review); LocalStore still owns the turn chain, fork and observers; commit 5a114409c -->
