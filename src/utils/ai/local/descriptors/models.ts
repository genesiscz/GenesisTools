...
/**
 * Model catalogue, one section per task. Moved verbatim out of the old
 * `ModelRegistry.ts` data blob; the query surface lives in `./index.ts`, which
 * lifts these entries into `LocalModelDescriptor`s.
 */

// ── Embedding models ──

export const EMBED_MODELS: ModelEntry[] = [
    {
...
export const TRANSCRIBE_MODELS: ModelEntry[] = [
    {
...
export const TRANSLATE_MODELS: ModelEntry[] = [
    {
...
export const SUMMARIZE_MODELS: ModelEntry[] = [
    {
...
export const TTS_MODELS: ModelEntry[] = [
    {
