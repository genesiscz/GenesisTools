...
import { getDaemonPid, startDaemon } from "@app/automate/lib/daemon";
import {
    DAEMON_STDERR_LOG,
    DAEMON_STDOUT_LOG,
    getDaemonStatus,
...
export function registerDaemonCommand(program: Command): void {
    ...
    daemon
        .command("start")
        .description("Run scheduler in foreground")
        .action(async () => {
    ...
    daemon
        .command("status")
        .description("Check daemon status and show recent logs")
        .action(async () => {
