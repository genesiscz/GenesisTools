    ...
    actions: [
        {
            ...
            description: "macOS desktop notification",
            params: [
        ...
        },
        {
            ...
            params: [{ name: "content", description: "Content to copy (or use 'message')" }],
        },
        {
            action: "notify.sound",
            description: "Play system sound",
            params: [{ name: "sound", description: "Sound name (default: 'Glass')" }],
        },
        {
