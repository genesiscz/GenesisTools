    ...
    actions: [
        {
            ...
            params: [{ name: "input", required: true, description: "JSON string to parse" }],
        },
        {
...
registerStepCatalog({
    ...
    actions: [
        {
            action: "text.regex",
            description: "Regex match or replace",
            params: [
        ...
        },
        {
            ...
            description: "Interpolate a template string",
            params: [{ name: "template", required: true, description: "Template with {{ expressions }}" }],
        },
        {
            action: "text.split",
...
registerStepCatalog({
    ...
    actions: [
        {
            action: "array.filter",
            description: "Filter items by expression",
            params: [
                { name: "input", required: true, description: "Array expression" },
        ...
        {
            action: "array.flatten",
            description: "Flatten nested arrays",
            params: [{ name: "input", required: true, description: "Array expression" }],
        },
    ],
});
