...
export function DashboardLayout({ children, title, description }: DashboardLayoutProps) {
    ...
    return (
        <SidebarProvider>
            ...
            {settings.gridBackground && <div className="fixed inset-0 cyber-grid opacity-40 pointer-events-none" />}
            {settings.scanLinesEffect && <div className="fixed inset-0 scan-lines opacity-30 pointer-events-none" />}
