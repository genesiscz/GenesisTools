 ...
 * </FeatureCard>
 */
export function FeatureCard({ color = "primary", onClick, className, children }: FeatureCardProps) {
 ...
 */
export function FeatureCardHeader({ className, children }: { className?: string; children: React.ReactNode }) {
 ...
 */
export function FeatureCardTitle({ className, children }: { className?: string; children: React.ReactNode }) {
 ...
 */
export function FeatureCardDescription({ className, children }: { className?: string; children: React.ReactNode }) {
 ...
 */
export function FeatureCardContent({ className, children }: { className?: string; children: React.ReactNode }) {
