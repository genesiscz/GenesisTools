            ...
            >
                ...
                <div className="flex items-center gap-5">
                    <div className="flex items-center gap-1.5" data-testid="habit-streak">
                        <Flame className={cn("h-4 w-4", habit.currentStreak > 0 ? "text-orange-400" : "text-muted-foreground/40")} />
                    ...
                    {habit.cadence === "weekly" && (
                        <div className="flex items-center gap-1.5" data-testid="habit-week-progress">
                            <span className={cn("text-lg font-bold tabular-nums", targetMet ? color.text : "text-foreground")}>
                                {habit.weekCount}
                            </span>
                            <span className="font-mono text-[10px] uppercase tracking-widest text-muted-foreground/50">
