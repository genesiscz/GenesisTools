...
import { Bell, CalendarDays, Clock, ListChecks, Sparkles } from "lucide-react";
            ...
            <div className="flex items-center justify-center min-h-[60vh]">
                <FeatureCard color="blue" className="max-w-lg w-full">
                    <FeatureCardHeader className="text-center">
                        ...
                        <Badge
                            variant="outline"
                            className="mx-auto mb-3 bg-blue-500/20 text-blue-400 border-blue-500/30 text-xs"
                        >
                            Coming Soon
                        </Badge>
                        ...
                        <FeatureCardDescription className="max-w-sm mx-auto">
                            Plan your perfect day with AI assistance. Smart scheduling, time blocking, and intelligent
