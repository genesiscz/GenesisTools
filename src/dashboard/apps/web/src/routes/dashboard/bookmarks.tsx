...
import { Bell, Bookmark, FolderTree, Globe, Sparkles } from "lucide-react";
            ...
            <div className="flex items-center justify-center min-h-[60vh]">
                <FeatureCard color="rose" className="max-w-lg w-full">
                    <FeatureCardHeader className="text-center">
                        ...
                        <Badge
                            variant="outline"
                            className="mx-auto mb-3 bg-rose-500/20 text-rose-400 border-rose-500/30 text-xs"
                        >
                            Coming Soon
                        </Badge>
                        ...
                        <FeatureCardDescription className="max-w-sm mx-auto">
                            Never lose a link again. AI-powered bookmark manager with automatic summaries, smart
                            categorization, and instant search.
                        </FeatureCardDescription>
                    </FeatureCardHeader>
