        ...
        <AuthLayout>
            <div className="space-y-6">
                ...
                <div className="text-center space-y-2">
                    ...
                    <p className="text-gray-400">Sign up to get started with Dashboard</p>
                </div>
                ...
                <div className="space-y-3">
                    <OAuthButton
                        provider="Google"
                        icon={GoogleIcon}
                        loading={oauthLoading === "GoogleOAuth"}
                    ...
                    <OAuthButton
                        ...
                        loading={oauthLoading === "GitHubOAuth"}
                        disabled={!!oauthLoading || isLoading}
                ...
                <div className="relative">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                        <span className="bg-[#0a0a14] px-4 text-gray-500">Or continue with email</span>
                    </div>
                </div>
                ...
                <div className="text-center text-sm">
                    ...
                    <Link to="/auth/signin" className="text-amber-500 font-medium hover:underline">
                        Sign in
                    </Link>
                </div>
            </div>
