...
import type { Task, Decision, TaskBlocker, ContextParking } from '@/lib/assistant/types'
                  ...
                  {blockers.map((blocker) => (
                    ...
                    >
                      ...
                      {blocker.blockerOwner && (
                        <span className="text-muted-foreground"> (owner: {blocker.blockerOwner})</span>
                      )}
                    </div>
                  ))}
                </div>
            ...
            <SectionPreview
              ...
              content={
                <div className="space-y-1">
                  ...
                  {nextSteps.length > 5 && (
                    <p className="text-xs text-muted-foreground">+{nextSteps.length - 5} more steps</p>
                  )}
                </div>
              }
            />
