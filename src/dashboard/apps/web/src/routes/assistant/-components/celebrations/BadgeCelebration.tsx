...
import { Trophy, Flame, Zap, X, Sparkles } from 'lucide-react'
...
export function BadgeCelebration({
  ...
  function getIcon() {
    if (celebration.trigger === 'streak-milestone') return Flame
    if (celebration.trigger === 'speedrunner') return Zap
    return Trophy
  }
      ...
      >
        ...
        >
          ...
          <h3
            ...
            className={cn('text-xl font-bold mb-2', styles.text)}
          >
            {celebration.title}
          </h3>
