...
import type { BadgeCelebrationData, MicroCelebrationData } from "./types";
...
export function StreakMilestone({ streakDays, onDismiss, particlesEnabled = true }: StreakMilestoneProps) {
    ...
    return <BadgeCelebration celebration={celebration} onDismiss={onDismiss} particlesEnabled={particlesEnabled} />;
}

/**
 * Create streak milestone celebration data
 */
export function createStreakMilestoneCelebration(streakDays: number): MicroCelebrationData | BadgeCelebrationData {
    const tier = getStreakTier(streakDays);
