 ...
 */
function TimelineNode({ decision, isLast, onClick }: { decision: Decision; isLast: boolean; onClick?: () => void }) {
    ...
    return (
        <div className="relative flex gap-4">
            ...
            <div className="relative flex flex-col items-center">
                {/* Node */}
                <div
                    className={cn("relative z-10 h-4 w-4 rounded-full border-2", colors.nodeClass)}
                    style={{
                ...
                {!isLast && (
                    <div
                        className={cn("w-0.5 flex-1 min-h-[60px]", colors.lineClass)}
                        style={{
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            >
                                ...
                                {decision.status === "reversed" && decision.reversalReason && (
                                    <p className="text-xs text-rose-400/80 mt-2">Reversed: {decision.reversalReason}</p>
                                )}
 ...
 */
export function DecisionTimeline({ decisions, onSelectDecision, className }: DecisionTimelineProps) {
    ...
    return (
        <div className={cn("space-y-2", className)}>
                ...
                return (
                    ...
                    >
                        ...
                        <div className="relative flex flex-col items-center">
                            ...
                            />
                            {index < sortedDecisions.length - 1 && <div className="w-px h-4 bg-white/10 mt-1" />}
                        </div>
            ...
            {decisions.length > maxItems && (
                <p className="text-xs text-muted-foreground text-center">+{decisions.length - maxItems} more</p>
            )}
        </div>
    );
}
