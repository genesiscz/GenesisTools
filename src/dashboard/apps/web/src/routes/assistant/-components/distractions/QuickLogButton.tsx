 ...
 */
export function QuickLogButton({ onLog, currentTask, loading = false, className }: QuickLogButtonProps) {
                    ...
                    <TooltipTrigger asChild>
                        ...
                        >
                            ...
                            <span className="absolute inset-0 rounded-full">
                                <span
                                    className={cn("absolute inset-0 rounded-full", "bg-cyan-400/20", "animate-ping")}
