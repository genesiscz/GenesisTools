...
export function KanbanCard({ task, isDragOverlay = false, className }: KanbanCardProps) {
    ...
    const deadlineInfo = task.deadline ? formatDeadlineRelative(new Date(task.deadline)) : null;
    ...
    return (
        ...
        >
            ...
            <div className="p-3 pl-5">
                ...
                {/* Description preview */}
                {task.description && (
                    <p className="text-[11px] text-muted-foreground line-clamp-1 mt-1">{task.description}</p>
                )}
