...
function generateReminderMessage(blocker: TaskBlocker): string {
    ...
    const daysSince = Math.floor((Date.now() - new Date(blocker.blockedSince).getTime()) / (1000 * 60 * 60 * 24));
            ...
            <Dialog open={remindDialogOpen} onOpenChange={setRemindDialogOpen}>
                <DialogContent className="sm:max-w-lg">
                    ...
                    <DialogFooter>
                        ...
                        <Button onClick={handleCopyMessage} className="gap-2 bg-rose-600 hover:bg-rose-700">
                            {copied ? (
                                <>
            ...
            <Dialog open={reminderDialogOpen} onOpenChange={setReminderDialogOpen}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>Set a date to be reminded about this blocker.</DialogDescription>
                    </DialogHeader>
            ...
            <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>Permanently remove this blocker. This cannot be undone.</DialogDescription>
                    </DialogHeader>
