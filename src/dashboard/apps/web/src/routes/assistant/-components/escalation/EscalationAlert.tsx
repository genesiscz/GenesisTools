 ...
 */
export function EscalationAlert({ open, onOpenChange, task, risk, onResolve }: EscalationAlertProps) {
                ...
                <DialogHeader className="space-y-3">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                            <DialogTitle
                                className={cn("text-lg font-bold", isCritical ? "text-red-400" : "text-yellow-400")}
                            >
