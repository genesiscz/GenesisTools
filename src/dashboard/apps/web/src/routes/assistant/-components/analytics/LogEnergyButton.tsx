...
const FOCUS_QUALITY_OPTIONS: Array<{
    ...
    { value: 2, label: "2", description: "Poor", color: "bg-red-800/40 border-red-500/30 hover:border-red-400" },
    {
        ...
        label: "3",
        description: "Average",
        color: "bg-amber-700/40 border-amber-500/30 hover:border-amber-400",
    },
    { value: 4, label: "4", description: "Good", color: "bg-cyan-600/40 border-cyan-500/30 hover:border-cyan-400" },
    {
        ...
        color: "bg-cyan-400/50 border-cyan-400/40 hover:border-cyan-300",
    },
];
 ...
 */
export function LogEnergyButton({ onLogEnergy, loading = false, className }: LogEnergyButtonProps) {
    ...
    return (
        <>
            <Button
                ...
                disabled={loading}
                className={cn("gap-2 border-cyan-500/30 hover:border-cyan-500/50 hover:bg-cyan-500/10", className)}
            >
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent className="bg-slate-950/95 border-cyan-500/30 max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>Record your current focus level and work type.</DialogDescription>
                    </DialogHeader>

                    <div className="space-y-6 py-4">
                        {/* Focus Quality */}
                        <div className="space-y-3">
                            <label className="text-sm font-medium text-slate-300">Focus Quality</label>
                            ...
                            <p className="text-xs text-slate-500 text-center">
                                ...
                                <span className="text-slate-300">
                                    {FOCUS_QUALITY_OPTIONS.find((o) => o.value === focusQuality)?.description}
                                </span>
                            </p>
                        </div>
                        ...
                        {/* Work Type */}
                        <div className="space-y-3">
                            <label className="text-sm font-medium text-slate-300">Type of Work</label>
 ...
 */
export function LogEnergyFAB({ onLogEnergy, loading = false, className }: LogEnergyButtonProps) {
    const [open, setOpen] = useState(false);
    const [focusQuality, setFocusQuality] = useState<FocusQuality>(3);
    const [typeOfWork, setTypeOfWork] = useState<WorkType>("deep-work");
    const [submitting, setSubmitting] = useState(false);
                            ...
                            {FOCUS_QUALITY_OPTIONS.map((option) => (
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        option.color,
                                        focusQuality === option.value ? "ring-2 ring-cyan-400 scale-110" : "opacity-50"
                                    )}
                                >
