 ...
 */
export function ReviewExport({ review, streak, comparison, formatWeekRange, disabled }: ReviewExportProps) {
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="outline" size="sm" className="gap-2" disabled={disabled || !review}>
...
function generateMarkdownReport(
    ...
    const deepFocusPercent =
        review.totalMinutes > 0 ? Math.round((review.deepFocusMinutes / review.totalMinutes) * 100) : 0;
