 ...
 * - Contact info
 */
export function HandoffDocument({ handoff, decisions = [], blockers = [], className, onCopy }: HandoffDocumentProps) {
    const [copied, setCopied] = useState(false);
    const [expandedSections, setExpandedSections] = useState<Set<string>>(new Set(["summary", "context", "nextSteps"]));
