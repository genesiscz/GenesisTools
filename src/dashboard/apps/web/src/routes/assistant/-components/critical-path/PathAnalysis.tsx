            ...
            <FeatureCard color="purple">
                <FeatureCardHeader className="pb-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <StatBox icon={Clock} label="Est. Days" value={daysToCompletion} color="purple" />
                        <StatBox icon={GitBranch} label="Max Depth" value={maxDepth} color="blue" />
                        <StatBox icon={Zap} label="Active Tasks" value={totalTasks} color="cyan" />
                        <StatBox icon={CheckCircle} label="Leaf Tasks" value={leafTasks} color="green" />
                    </div>
                </FeatureCardHeader>
            </FeatureCard>
                    ...
                    <FeatureCardHeader className="pb-3">
                                ...
                                return (
                                    <div key={task.id} className="flex items-center gap-2">
                                        ...
                                        <div className="flex flex-col items-center">
                                            ...
                                            {!isLast && <div className="w-0.5 h-4 bg-red-500/30" />}
                                        </div>
                        ...
                        <div className="mt-3 pt-3 border-t border-red-500/20">
                            <div className="flex items-center gap-2 text-xs text-red-300/80">
                                ...
                                <span>Complete this path to ship in ~{daysToCompletion} days</span>
                            </div>
                        </div>
                    </FeatureCardHeader>
                </FeatureCard>
                ...
                <FeatureCard color="amber">
                    <FeatureCardHeader className="pb-3">
                        ...
                        <p className="text-xs text-muted-foreground mb-3">
                            These tasks block multiple other tasks. Prioritize them to unblock more work.
                        </p>
...
function StatBox({
    ...
    return (
        <div className={cn("p-2 rounded-lg border text-center", colorClasses[color])}>
