...
import type { DeadlineRisk, Task } from "@/lib/assistant/types";
        ...
        <>
            <button
                ...
                className={cn(
                    ...
                    isCritical ? "shadow-sm hover:shadow-red-500/20" : "shadow-sm hover:shadow-yellow-500/20",
                    className
                )}
                style={{
            ...
            >
                ...
                {/* Risk text */}
                <span className={cn("text-sm font-medium", isCritical ? "text-red-400" : "text-yellow-400")}>
