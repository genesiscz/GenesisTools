    ...
    return (
        <div className="bg-[#0a0a14]/95 border border-white/10 rounded-lg p-3 shadow-xl">
            <div className="flex items-center gap-2 mb-2">
                <Icon className="h-4 w-4" style={{ color: sourceColors[data.source].fill }} />
 ...
 */
export function DistractionStats({ stats, trend, loading = false, className }: DistractionStatsProps) {
                        ...
                        <PieChart>
                            ...
                            <Legend
                                formatter={(value: DistractionSource) => (
                                    <span className="text-sm text-muted-foreground">{sourceLabels[value]}</span>
                                )}
                            />
                        </PieChart>
                    </ResponsiveContainer>
                        ...
                        <p className="text-sm">
                            ...
                            {stats.bySource[stats.mostCommonSource] && (
                                <span className="text-muted-foreground">
                                    ...
                                    (
                                    {Math.round(
                                        (stats.bySource[stats.mostCommonSource].count / stats.totalDistractions) * 100
                                    )}
