...
import type { BadgeRarity, CelebrationTier } from "@/lib/assistant/types";
 ...
 */
export type CelebrationData = MicroCelebrationData | BadgeCelebrationData | FullCelebrationData;
...
export const CELEBRATION_MESSAGES = {
    ...
    dailyGoal: ["You're on a roll! 3 tasks today.", "Daily goal hit! Great momentum.", "Crushing it! Keep going."],
    speedrunner: ["5 tasks in one day! Speedrunner mode activated.", "Blazing through tasks! 5 completed today."],
