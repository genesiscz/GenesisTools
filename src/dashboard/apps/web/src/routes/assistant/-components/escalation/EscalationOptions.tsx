            ...
            >
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className={cn('font-semibold', option.colorClass)}>
                    {option.title}
                  </h4>
    ...
    <div className="space-y-3">
      <div>
        ...
        <Input
          ...
          onChange={(e) =>
            onChange({ ...value, helperName: e.target.value })
          }
        />
      </div>
      <div>
        ...
        <Textarea
          ...
          onChange={(e) =>
            onChange({ ...value, helperNotes: e.target.value })
          }
        />
      </div>
    </div>
...
function ScopeForm({
  ...
  return (
    <div className="space-y-3">
        ...
        <ul className="space-y-1.5">
          {scopeItems.map((item, index) => (
            ...
            >
              ...
              <span className="flex-1 text-amber-200 line-through opacity-70">
                {item}
              </span>
              <button
                type="button"
      ...
      <p className="text-xs text-muted-foreground">
        List features that can be deferred to a future release.
      </p>
    </div>
  )
}
    ...
    <div className="space-y-3">
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-red-300/70 mt-1">
              By accepting this risk, you acknowledge the deadline may be missed.
      ...
      <div>
        ...
        <Textarea
          ...
          onChange={(e) =>
            onChange({ ...value, acceptanceNote: e.target.value })
          }
        />
      </div>
    </div>
