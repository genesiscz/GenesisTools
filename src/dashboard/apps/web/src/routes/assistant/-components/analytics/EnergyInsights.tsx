import { Activity, Calendar, Minus, Moon, TrendingDown, TrendingUp, Zap } from "lucide-react";
...
function InsightCard({
    ...
    return (
        <div className={cn("rounded-lg border p-4", colorClasses[color], className)}>
                        ...
                        <ul className="space-y-1.5 text-sm text-slate-500">
                            ...
                            {totalContextSwitches > 20 && (
                                <li className="flex items-start gap-2">
                                    <span className="text-cyan-400">-</span>
                                    <span>
                                        High context switches detected. Try time-blocking to reduce interruptions
                                    </span>
                                </li>
                            )}
                            {trend === "declining" && (
