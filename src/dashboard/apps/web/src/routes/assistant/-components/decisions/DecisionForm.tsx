...
import { FormDialog, FormField, PrefixedInput, TagChip } from "@ui/custom";
...
export function DecisionForm({
    ...
    return (
        <FormDialog
            ...
            submitLabel={isSubmitting ? "Saving..." : isEdit ? "Save Changes" : "Record Decision"}
            submitDisabled={!title.trim() || !reasoning.trim()}
            isSubmitting={isSubmitting}
            maxWidth="sm:max-w-[600px] max-h-[90vh] overflow-y-auto"
        >
            <div className="space-y-5">
                {/* Title */}
                <FormField id="title" label="Decision Title" required>
                    <Input
                        id="title"
                        value={title}
                ...
                {/* Reasoning */}
                <FormField id="reasoning" label="Reasoning" required>
                    <Textarea
                        id="reasoning"
                        value={reasoning}
                ...
                <div className="grid grid-cols-2 gap-4">
                    {/* Impact area */}
                    <FormField label="Impact Area" required>
                    ...
                    {/* Decision date */}
                    <FormField id="decidedAt" label="Decision Date">
                        <PrefixedInput
                            icon={<Calendar />}
                            id="decidedAt"
                            type="date"
                ...
                {/* Decided by */}
                <FormField id="decidedBy" label="Decided By">
                    <PrefixedInput
                        icon={<User />}
                        id="decidedBy"
                        value={decidedBy}
                    ...
                    {existingTags.length > 0 && (
                        <div className="flex flex-wrap gap-1 mt-2">
                            ...
                            {existingTags.slice(0, 8).map((tag) => (
                                ...
                                >
                                    <TagChip className="hover:bg-white/10 hover:text-foreground transition-colors">
                                        {tag}
                                    </TagChip>
                                </button>
                            ))}
