import { Award, Flame, CheckCircle, Trophy, Brain, Target, Rocket, Crown } from 'lucide-react'
import { cn } from '@/lib/utils'
import type { WeeklyReview, BadgeType, BadgeRarity } from '@/lib/assistant/types'
