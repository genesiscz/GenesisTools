 ...
 */
export function ContextParkingModal({ open, onOpenChange, tasks, currentTaskId, onPark }: ContextParkingModalProps) {
    ...
    }, [open, currentTaskId, tasks.find]);

    async function handleSubmit() {
        if (!selectedTaskId || !content.trim()) {
            return;
        }
