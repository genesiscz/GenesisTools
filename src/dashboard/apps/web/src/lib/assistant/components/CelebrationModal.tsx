        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[500px] bg-transparent border-0 shadow-none overflow-visible">
                ...
                >
                    ...
                    {/* Task title */}
                    <p className="relative text-lg text-foreground/90 mb-4 line-clamp-2">"{task.title}"</p>

                    {/* Urgency-specific message */}
                    <p className="relative text-sm text-muted-foreground mb-6">{urgencyMessage[task.urgencyLevel]}</p>
