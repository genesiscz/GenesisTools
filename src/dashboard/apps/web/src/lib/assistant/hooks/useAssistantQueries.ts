...
export function useUpdateAssistantBlockerMutation() {
  ...
  return useMutation({
    mutationFn: ({ id, data, userId, taskId }: { id: string; data: Partial<NewAssistantBlocker>; userId: string; taskId: string }) =>
...
export function useUpdateAssistantHandoffMutation() {
  ...
  return useMutation({
    mutationFn: ({ id, data, userId, taskId }: { id: string; data: Partial<NewAssistantHandoff>; userId: string; taskId: string }) =>
