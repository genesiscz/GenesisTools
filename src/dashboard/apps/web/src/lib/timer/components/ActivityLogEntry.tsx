...
import { CheckCircle2, Clock, Coffee, Flag, Pause, Play, RotateCcw, Zap } from "lucide-react";
import { useSettings } from "@/lib/hooks/useSettings";
import { formatDurationHuman, formatTimeCompact } from "@/lib/timer/hooks/useTimerEngine";
                    ...
                    {entry.sessionDuration !== undefined && (
                        ...
                        >
                            ...
                            <span className="text-amber-400 font-mono">
                                {formatDurationHuman(entry.sessionDuration)}
                            </span>
                        </div>
                    )}
