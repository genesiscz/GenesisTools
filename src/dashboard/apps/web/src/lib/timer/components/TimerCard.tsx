 ...
 */
export const TimerCard = memo(function TimerCard({ timerId, userId, onDelete, onPopout, className }: TimerCardProps) {
    ...
    if (!timer) {
        return <div className={cn("animate-pulse rounded-xl bg-gray-800/50 h-48", className)} />;
    }
    ...
    return (
        ...
        >
            ...
            <div
                className={cn(
                    "absolute top-0 left-0 w-5 h-5 border-l-2 border-t-2 rounded-tl-lg transition-colors",
                    colors.corner
                )}
            />
            <div
                className={cn(
                    "absolute top-0 right-0 w-5 h-5 border-r-2 border-t-2 rounded-tr-lg transition-colors",
                    colors.corner
                )}
            />
            <div
                className={cn(
                    "absolute bottom-0 left-0 w-5 h-5 border-l-2 border-b-2 rounded-bl-lg transition-colors",
                    colors.corner
                )}
            />
            <div
                className={cn(
                    "absolute bottom-0 right-0 w-5 h-5 border-r-2 border-b-2 rounded-br-lg transition-colors",
                    colors.corner
                )}
            />
            ...
            <div className="relative p-4 space-y-3">
                ...
                <div className="flex items-start justify-between gap-3">
                            ...
                            <span
                                className={cn(
                                    ...
                                    timer.timerType === "countdown" &&
                                        "bg-amber-400 shadow-[0_0_8px_rgba(255,149,0,0.8)]",
                    ...
                    <TimerTypeSelector type={timer.timerType} onChange={setType} disabled={isRunning} />
                ...
                {isEditingTime ? (
                    timer.timerType === "stopwatch" ? (
                        ...
                        <CountdownPicker onSelect={handleDurationSelect} />
                    ) : (
