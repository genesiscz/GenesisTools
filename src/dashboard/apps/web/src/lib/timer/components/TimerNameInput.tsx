 ...
 */
export const TimerNameInput = memo(function TimerNameInput({ name, onNameChange, className }: TimerNameInputProps) {
    ...
    return (
        <button
            ...
            title="Click to edit"
        >
            <span className="text-sm font-semibold text-white truncate max-w-[160px]">{name}</span>
