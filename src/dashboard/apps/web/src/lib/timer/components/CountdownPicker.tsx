 ...
 */
export const CountdownPicker = memo(function CountdownPicker({ onSelect, className }: CountdownPickerProps) {
        ...
        <div className={cn("space-y-3", className)}>
            ...
            <div className="flex items-center gap-2 pt-2 border-t border-gray-800">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <span className="w-12 text-center font-mono text-amber-400">{customMinutes}m</span>
                    <button
