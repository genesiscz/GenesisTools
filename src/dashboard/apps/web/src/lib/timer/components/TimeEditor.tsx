...
export function TimeEditor({
  ...
  function handleSave() {
    const h = Math.min(parseInt(hours) || 0, maxHours)
  ...
  function handleKeyDown(
    ...
    if (e.key === 'ArrowUp') {
      e.preventDefault()
      if (field === 'hours') adjustValue(hours, setHours, maxHours, 1)
      else if (field === 'minutes') adjustValue(minutes, setMinutes, 59, 1)
      else adjustValue(seconds, setSeconds, 59, 1)
      return
    }
