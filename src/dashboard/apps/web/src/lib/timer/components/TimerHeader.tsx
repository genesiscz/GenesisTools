 ...
 */
export function TimerHeader({ timerCount, runningCount, onAddTimer, onOpenActivityLog, className }: TimerHeaderProps) {
    return (
        <header
            className={cn("relative z-20", "border-b border-amber-500/20", "bg-black/60 backdrop-blur-xl", className)}
        >
            {/* Decorative top line */}
                            ...
                            <div className="flex items-center gap-4 mt-1">
                                <span className="text-xs text-gray-500 font-mono">
                                    {timerCount === 0 ? (
                                        ...
                                        <>
                                            <span className="text-gray-400">{timerCount}</span> timer
                                            {timerCount !== 1 ? "s" : ""}
                                        </>
                                    )}
                                </span>
