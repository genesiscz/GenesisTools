...
function StructuredPage() {
    ...
    const filteredProviders = ALL_PROVIDERS.filter((p) => availableProviders.includes(p.id));
        ...
        return (
            <div className="min-h-[calc(100vh-80px)] bg-gray-900 p-6">
                <div className="max-w-2xl mx-auto text-center py-16">
                    ...
                    <h1 className="text-2xl font-bold text-white mb-4">No Providers Available</h1>
                    <p className="text-gray-400 mb-4">
                        Please configure at least one AI provider in your{" "}
                        <code className="text-orange-400">.env.local</code> file, or ensure Ollama is running locally.
                    </p>
                </div>
            </div>
        );
        ...
        <div className="min-h-[calc(100vh-80px)] bg-gray-900 p-6">
            <div className="max-w-6xl mx-auto">
                ...
                <p className="text-gray-400 mb-6">
                    Compare two output modes: <strong className="text-orange-400">One-Shot</strong> returns freeform
                    markdown, while <strong className="text-orange-400">Structured</strong> returns validated JSON
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-300 mb-2">Output Mode</label>
                        ...
                        <div className="mt-6 p-4 bg-gray-800/50 rounded-lg border border-gray-700">
                            <h4 className="text-sm font-medium text-gray-400 mb-2">Structured Output Schema</h4>
                        ...
                        {result ? (
                            <div className="space-y-4">
                                ...
                                <div className="pt-4 border-t border-gray-700 text-sm text-gray-400">
                                    <p>
                                        Provider: <span className="text-orange-400">{result.provider}</span>
                                    </p>
                                    <p>
                                        Model: <span className="text-orange-400">{result.model}</span>
                                    </p>
                                </div>
                            </div>
                        ) : !error && !isLoading ? (
