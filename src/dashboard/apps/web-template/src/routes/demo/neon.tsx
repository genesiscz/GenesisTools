            ...
            <div className="bg-black/30 p-6 rounded-lg max-w-xl mx-auto">
                ...
                <ul className="space-y-4 text-left list-none">
                    <li className="flex items-start">
                        ...
                        <div>
                            Use the <code className="bg-black/30 px-2 py-1 rounded">db/init.sql</code> file to create
                            the database
                        </div>
                    </li>
                    <li className="flex items-start">
                        ...
                        <div>
                            Set the <code className="bg-black/30 px-2 py-1 rounded">DATABASE_URL</code> environment
