...
export type LiveChannel = "ports" | "pulse" | "qa" | "ai-usage" | `boards:${string}` | `daemon:${string}`;
...
export type LiveFrame =
    ...
    /** The all-provider usage cache changed on disk. `native` is already stripped. */
    | { v: 1; channel: "ai-usage"; type: "snapshot"; payload: AiUsageResult }
