...
/**
 * Styled native input element that applies a set of sensible default classes and forwards all provided props.
 *
 ...
 * @param props - Any other standard input props are forwarded to the underlying element
