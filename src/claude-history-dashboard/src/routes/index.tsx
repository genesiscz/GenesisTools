        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative max-w-2xl">
            ...
            <div className="relative flex items-center gap-2">
              ...
              <Badge variant="outline" className="h-14 px-4 glass-card border-amber-500/30 text-amber-500/60 font-mono text-xs">
            ...
            {filteredConversations.map((conv, idx) => (
              ...
              >
                <Card className="group glass-card border-amber-500/10 hover:border-amber-500/30 bg-transparent transition-all duration-300 hover:scale-[1.005] overflow-hidden">
                  {/* Left accent bar */}
                  <div className={`absolute left-0 top-0 bottom-0 w-1 ${conv.isSubagent ? 'bg-cyan-500' : 'bg-amber-500'} opacity-60 group-hover:opacity-100 transition-opacity`} />
                  ...
                  <CardHeader className="pb-2 pl-5">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex gap-2 flex-shrink-0">
                        <Badge variant="outline" className="bg-cyan-500/10 text-cyan-400 border-cyan-500/30 font-mono text-[10px] tracking-wider">
                          {conv.project}
                        </Badge>
                        {conv.isSubagent && (
                          <Badge variant="outline" className="bg-amber-500/10 text-amber-400 border-amber-500/30 font-mono text-[10px] tracking-wider animate-pulse-glow">
                            AGENT
                          </Badge>
                        )}
                      </div>
