...
- Handing the work to a non-Claude worker instead of a subagent? That is `gt:handoff-to` (routing, plus per-backend mechanics in its `references/`), not this skill.
